...
public class WorkoutSessionResponse {
    ...
    private ReviewDTO trainerReview;
    private Set<PerformedExerciseDTO> performedExercises;

    public WorkoutSessionResponse(Long workoutId, @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd.MM.yyyy")Date date, ReviewDTO userReview, ReviewDTO trainerReview) {
