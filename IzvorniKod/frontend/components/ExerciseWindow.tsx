    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full h-[70vh] flex flex-col"> 
        ...
        <div className="flex space-x-4 mb-4 border-b pb-2">
          <button
            className={`font-semibold ${activeTab === "About" ? "text-gray-800 border-b-2 border-gray-800" : "text-gray-500"}`}
            onClick={() => setActiveTab("About")}
          >
            About
          </button>
          <button
            className={`font-semibold ${activeTab === "History" ? "text-gray-800 border-b-2 border-gray-800" : "text-gray-500"}`}
            onClick={() => setActiveTab("History")}
          >
            History
          </button>
          <button
            className={`font-semibold ${activeTab === "HowTo" ? "text-gray-800 border-b-2 border-gray-800" : "text-gray-500"}`}
        ...
        <div className="flex-grow overflow-y-auto"> 
          {activeTab === "About" && (
            <div>
              ...
              <div className="mb-4">
                <img src={exercise.gifUrl} alt={exercise.name} className="w-full rounded-md" />
              </div>
            </div>
          )}
          {activeTab === "History" && (
